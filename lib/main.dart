...
import 'package:ppt_view_flutter/permission_service.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void initCheckPermission() async {
    ...
    await _handler.requestPermission(Permission.storage,
  ...
  Future<void> initPlatformState() async {
    ...
    final url =  "https://www.unm.edu/~unmvclib/powerpoint/pptexamples.ppt";
    //"https://file-examples-com.github.io/uploads/2017/02/file_example_XLS_5000.xls";
